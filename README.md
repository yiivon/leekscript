...
LeekScript is a language initially designed for Leek Wars, and for games in general. Design to be simple to use, but with rich syntax and functionnalities, and a good speed.
