...
public:
	 ...
	 */
	VM::Result compile(VM& vm, Context* context = nullptr, bool assembly = false, bool pseudo_code = false, bool ir = false, bool bitcode = false);
	VM::Result compile_leekscript(VM& vm, Context* ctx, bool assembly, bool pseudo_code);
