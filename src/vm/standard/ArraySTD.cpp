...
ArraySTD::ArraySTD() : Module("Array") {
	...
	method("chunk", {
		{Type::PTR_ARRAY_ARRAY, {Type::PTR_ARRAY}, (void*) ArraySTD::chunk_1_ptr, Method::NATIVE},
		{Type::REAL_ARRAY_ARRAY, {Type::REAL_ARRAY}, (void*) ArraySTD::chunk_1_float, Method::NATIVE},
		{Type::INT_ARRAY_ARRAY, {Type::INT_ARRAY}, (void*) ArraySTD::chunk_1_int, Method::NATIVE},
		{Type::PTR_ARRAY_ARRAY, {Type::PTR_ARRAY, Type::INTEGER}, (void*) &LSArray<LSValue*>::ls_chunk, Method::NATIVE},
		{Type::REAL_ARRAY_ARRAY, {Type::REAL_ARRAY, Type::INTEGER}, (void*) &LSArray<double>::ls_chunk, Method::NATIVE},
		{Type::INT_ARRAY_ARRAY, {Type::INT_ARRAY, Type::INTEGER}, (void*) &LSArray<int>::ls_chunk, Method::NATIVE},
    });
	...
	method("contains", {
		{Type::BOOLEAN, {Type::PTR_ARRAY, Type::POINTER}, (void*) &LSArray<LSValue*>::ls_contains, Method::NATIVE},
	...
	method("max", {
		{Type::POINTER, {Type::PTR_ARRAY}, (void*) &LSArray<LSValue*>::ls_max, Method::NATIVE},
		{Type::REAL, {Type::REAL_ARRAY}, (void*) &LSArray<double>::ls_max, Method::NATIVE},
		{Type::INTEGER, {Type::INT_ARRAY}, (void*) &LSArray<int>::ls_max, Method::NATIVE}
	});

	method("min", {
		{Type::POINTER, {Type::PTR_ARRAY}, (void*) &LSArray<LSValue*>::ls_min, Method::NATIVE},
		{Type::REAL, {Type::REAL_ARRAY}, (void*) &LSArray<double>::ls_min, Method::NATIVE},
		{Type::INTEGER, {Type::INT_ARRAY}, (void*) &LSArray<int>::ls_min, Method::NATIVE}
	});
	...
	method("map", {
		...
		{Type::PTR_ARRAY, {Type::INT_ARRAY, map_int_ptr_fun_type}, (void*) map_int_ptr, Method::NATIVE},
	...
	method("sum", {
		...
		{Type::REAL, {Type::REAL_ARRAY}, (void*) &LSArray<double>::ls_sum, Method::NATIVE},
