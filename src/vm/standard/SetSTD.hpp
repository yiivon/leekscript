...
public:
	...
	static Compiler::value insert_any(Compiler& c, std::vector<Compiler::value> args);
	static Compiler::value insert_real(Compiler& c, std::vector<Compiler::value> args);
	static Compiler::value insert_int(Compiler& c, std::vector<Compiler::value> args);
};
