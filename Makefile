...
travis:
	...
	docker run -e COVERALLS_REPO_TOKEN="$$COVERALLS_REPO_TOKEN" -e TRAVIS_BRANCH="master" leekscript /bin/bash -c "cd leekscript; make coverage && build/leekscript-coverage -test && cpp-coveralls --gcov-options='-r'"
