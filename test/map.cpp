...
void Test::test_map() {
	...
	DISABLED_code("var x = ['a' : 'b'] var y = [1 : 1] x.clear() == y.clear()").equals("true");
	for (auto& m1 : maps)
		for (auto& m2 : maps)
	...
	DISABLED_code("[1: 1, 2: 0] < [1: 1, 2: true]").equals("false");
	DISABLED_code("[1: 1, 2: 0.5] < [1: 1, 2: true]").equals("false");
	...
	DISABLED_code("let m = [5: 12] m['salut']").semantic_error(ls::SemanticError::INVALID_MAP_KEY, {"'salut'", "m", ls::Type::STRING_TMP.to_string()});
	DISABLED_code("let m = [5.7: 'hello'] m['salut']").semantic_error(ls::SemanticError::INVALID_MAP_KEY, {"'salut'", "m", ls::Type::STRING_TMP.to_string()});
	code("var m = [1: 'a', 2: 'b'] m[2] = 'B' m").equals("[1: 'a', 2: 'B']");
	DISABLED_code("var m = [1: 'a', 2: 'b'] m[3]").exception(ls::vm::Exception::ARRAY_OUT_OF_BOUNDS);
	...
	DISABLED_code("var m = ptr(['a': '2']) m['c'] = '6' m").equals("['a': '2', 'c': '6']");
	DISABLED_code("var m = ptr([2: 'a']) m[3] = 'b' m").equals("[2: 'a', 3: 'b']");
	DISABLED_code("var m = ptr([2.5: 'a']) m[3.6] = 'b' m").equals("[2.5: 'a', 3.6: 'b']");
	DISABLED_code("var m = ptr(['a': 2]) m['c'] = 6 m").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
	DISABLED_code("var m = ptr(['a': 2.2]) m['c'] = 6.6 m").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
	DISABLED_code("var m = ptr([2: 2]) m[3] = 6 m").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
	DISABLED_code("var m = ptr([2.5: 2]) m[3.5] = 6 m").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
	DISABLED_code("var m = ptr([2.5: 2.8]) m[3.5] = 6 m").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
	DISABLED_code("var m = ptr([2: 2.8]) m[3] = 6 m").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
	DISABLED_code("var m = ptr([2: 'a']) m['toto'] = 'b' m").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
	DISABLED_code("var m = ptr([2.5: 'a']) m['toto'] = 'b' m").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
	...
	DISABLED_code("[12 : 0].clear().max()").exception(ls::vm::Exception::ARRAY_OUT_OF_BOUNDS);
	...
	section("Map.maxKey()");
	DISABLED_code("[:].maxKey()").exception(ls::vm::Exception::ARRAY_OUT_OF_BOUNDS);
	DISABLED_code("[12 : 0].clear().maxKey()").exception(ls::vm::Exception::ARRAY_OUT_OF_BOUNDS);
	...
	DISABLED_code("[12 : 0].clear().min()").exception(ls::vm::Exception::ARRAY_OUT_OF_BOUNDS);
	...
	section("Map.minKey()");
	DISABLED_code("[:].minKey()").exception(ls::vm::Exception::ARRAY_OUT_OF_BOUNDS);
	DISABLED_code("[12 : 0].clear().minKey()").exception(ls::vm::Exception::ARRAY_OUT_OF_BOUNDS);
