...
void Test::test_map() {
	...
	DISABLED_code("let x = ['a': 1] x.look(3.14, 'a')").error(ls::Error::METHOD_NOT_FOUND, {ls::Type::const_map(ls::Type::any(), ls::Type::integer()).to_string() + ".look(" + ls::Type::real().to_string() + ", " + ls::Type::tmp_string().to_string() + ")"});
